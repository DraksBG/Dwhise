            ...
            <div className="flex flex-1 flex-col gap-6 items-center justify-start w-full">
              ...
              <div className="flex flex-col items-end justify-start w-[99%] md:w-full">
                <div className="flex md:flex-col flex-row md:gap-5 items-center justify-end w-[96%] md:w-full">
                  ...
                  >
                    <div className="bg-gray-50_02 flex flex-col gap-[11px] items-start justify-start outline outline-[1px] outline-blue_gray-50 p-[7px] w-full">
                      <Text
                  ...
                  <div className="bg-gray-50_02 flex flex-col gap-[11px] items-start justify-start outline outline-[1px] outline-blue_gray-50 p-[7px]">
                    <Text
                      className="text-blue_gray-400 text-xs"
                      size="txtGilroyMedium12"
                    >
                  ...
                  >
                    <div className="flex flex-1 md:flex-col flex-row gap-[9px] items-start justify-between my-0 w-full">
                      ...
                      <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start">
                        <div className="bg-gray-50_02 flex flex-row items-start justify-start outline outline-[1px] outline-blue_gray-50 w-[15%] md:w-full">
                          <Line className="bg-blue-A200_01 h-[72px] w-1" />
                        ...
                        <div className="bg-gray-50_02 h-[74px] outline outline-[1px] outline-blue_gray-50 w-[15%]"></div>
                        <div className="bg-gray-50_02 h-[74px] outline outline-[1px] outline-blue_gray-50 w-[15%]"></div>
                        <div className="bg-gray-50_02 h-[74px] outline outline-[1px] outline-blue_gray-50 w-[15%]"></div>
                    ...
                    <div className="flex flex-1 md:flex-col flex-row gap-[9px] items-start justify-between my-0 w-full">
                      ...
                      <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start">
                        <div className="bg-gray-50_02 h-[74px] outline outline-[1px] outline-blue_gray-50 w-[15%]"></div>
                        <div className="bg-gray-50_02 h-[74px] outline outline-[1px] outline-blue_gray-50 w-[15%]"></div>
                        <div className="bg-gray-50_02 flex flex-row items-start justify-center outline outline-[1px] outline-blue_gray-50 w-[15%] md:w-full">
